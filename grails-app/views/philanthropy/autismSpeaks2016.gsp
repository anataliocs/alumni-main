...
<title>Theta Delta Chi Rho Triton with Autism Speaks and Alpha Xi Delta 2016</title>
...
<div class="container marketing">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            ...
            <h1>Alpha Xi Delta's Amaxing Challenge 2016<span
                    class="text-muted">Xi Marks the Spot!</span></h1>
            <h4><span class="text-muted">Sunday April 23th, 2016 from 11AM - 2PM</span></h4><br/><br/>
            <h4>Virginia Commonwealth University Commons Plaza</h4><br/><br/>
    ...
    <div class="row text-center">
        ...
        <div>
            ...
            <g:render template="/blocks/philanthropyChair"></g:render>
        </div>
